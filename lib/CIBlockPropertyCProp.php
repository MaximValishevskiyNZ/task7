...
class CIBlockPropertyCProp
{
    ...
    public function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName)
    {
        ...
        foreach ($arFields as $code => $arItem) {
            if ($arItem['TYPE'] === 'string') {
                ...
                $result .= self::showHTMLvEditor($code, $arItem['TITLE'], $value, $strHTMLControlName);
            }
        }
    ...
    public static function showHTMLvEditor($code, $title, $arValue, $strHTMLControlName)
    {
        $result = "";
        $v = !empty($arValue['VALUE'][$code]) ? $arValue['VALUE'][$code] : '';
        ...
        <tr>
            ...
            <td>
                <? CFileMan::AddHTMLEditorFrame(
                    ...
                    $v,
                    $code . "_TYPE",
                    $strHTMLControlName["VALUE"] ? "html" : "text",
                ); ?>
            </td>
        </tr>
        <?
